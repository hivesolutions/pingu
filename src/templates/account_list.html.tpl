...
{% block content %}
    <ul class="filter" data-no_input="1">
        ...
        <li class="template table-row">
            <div class="status text-center" data-width="80">%[username]</div>
            <div class="date text-left" data-width="170">%[last_login_l]</div>
            <div class="latency text-left" data-width="80">%[email]</div>
            <div class="latency text-right" data-width="250">%[login_count] times</div>
            <div class="clear"></div>
        </li>
