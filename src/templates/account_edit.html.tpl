...
{% block content %}
    <form action="{{ url_for('update_account', username = account.username) }}" method="post" class="form">
        ...
        <div class="input">
            <input class="text-field" data-disabled="1" name="username" autocomplete="off" value="{{ account.username }}"
        ...
        <div class="input">
            <input class="text-field" name="email" data-disabled="1" autocomplete="off" value="{{ account.email }}"
        ...
        <div class="input">
            <input class="text-field" name="twitter" autocomplete="off" value="{{ account.facebook }}"
            	   data-error="{{ errors.twitter }}" />
        </div>
